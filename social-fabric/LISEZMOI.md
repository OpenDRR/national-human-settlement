[In English](https://github.com/OpenDRR/national-human-settlement/blob/main/social-vulnerability/README.md)

Auto-généré à partir de nhsl.yml

# Zones de peuplement au niveau national - Vulnérabilité sociale
